...
#if defined(__VER_1_2__)
   uint8_t  reserved_1;
#elif defined(__VER_1_4__) || defined(__VER_1_5__) ||defined(__VER_2_0__) ||defined(__VER_2_0__)
   uint8_t  numgest;
#endif
   uint16_t gesten;
   uint8_t  pressproc;
...
//
//*****************************************************************************
QT_EXT void get_message(struct ts_event *tch);

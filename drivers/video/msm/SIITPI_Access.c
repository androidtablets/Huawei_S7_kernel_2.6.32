...
boolean GetDDC_Access (byte* SysCtrlRegVal)
{
    byte sysCtrl;
...
boolean ReleaseDDC(byte SysCtrlRegVal)
{
    byte DDCReqTimeout = T_DDC_ACCESS;
    byte TPI_ControlImage;
...
boolean SetChannelLayout(byte Count)
{
...
boolean SetInputWordLength(byte Length)
{
    byte RegValue;
